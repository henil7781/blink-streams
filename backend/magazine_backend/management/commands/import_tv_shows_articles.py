...
from magazine_backend.models import TVShowsArticle
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        csv_path = os.path.join(settings.BASE_DIR, 'data', 'new_tvshows_with_articles_data.csv')
