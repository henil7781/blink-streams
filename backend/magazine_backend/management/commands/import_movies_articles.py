...
from magazine_backend.models import MoviesArticle
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        csv_path = os.path.join(settings.BASE_DIR, 'data', 'new_movies_with_articles_data.csv')
