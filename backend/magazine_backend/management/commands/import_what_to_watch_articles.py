...
from magazine_backend.models import WhatToWatchArticle
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        csv_path = os.path.join(settings.BASE_DIR, 'data', 'new_what-to_watch_with_articles_data.csv')
